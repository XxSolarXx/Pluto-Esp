...
if not syn and not PROTOSMASHER_LOADED then print'This esp supports many executors including Pluto Executor v14. Credits goes to XxSolarXx discord.gg/getpluto' end
...
local LastRefresh = 0
local OptionsFile = 'Pluto_ESP_SETTINGS.dat'
local Binding = false
local BindedKey = nil
local OIndex = 0
local LineBox = {}
...
shared.RSName = shared.RSName or ('Pluto Esp made by XxSolarXx' .. HttpService:GenerateGUID(false))
...
Options('MenuKey', 'Menu Key', Enum.KeyCode.F5, 1);
Options('ToggleKey', 'Toggle Key', Enum.KeyCode.F1, 1);
